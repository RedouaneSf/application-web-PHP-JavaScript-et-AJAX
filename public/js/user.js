$(document).ready(function() {
  ...
  function fetchData() {
    $.ajax({
      url: "./userRepos.php?action=fetchData",
      type: "POST",
      dataType: "json",
  ...
  $("#insertForm").on("submit", function(e) {
    ...
    e.preventDefault();
    $.ajax({
      url: "userRepos.php?action=insertData",
      type: "POST",
  ...
  $("#myTable").on("click", ".deleteBtn", function() {
    if(confirm("Are you sure you want to delete this user?")) {
      ...
      $.ajax({
        url: "./userRepos.php?action=deleteData",
        type: "POST",
        dataType: "json",
        data: {
          id,
  ...
  $("#myTable").on("click", ".editUser", function() {
    var id = $(this).val();
    $.ajax({
      url: "userRepos.php?action=fetchSingle",
      type: "POST",
      dataType: "json",
      data: {
        id: id
  ...
  $("#editForm").on("submit", function(e) {
    ...
    e.preventDefault();
    $.ajax({
      url: "userRepos.php?action=updateData",
      type: "POST",
      data: new FormData(this),
      contentType: false,
      cache: false,
