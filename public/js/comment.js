$(document).ready(function() {
  ...
  function fetchData() {
    $.ajax({
      url: "./commentRepos.php?action=fetchData",
      type: "POST",
      dataType: "json",
  ...
  $("#insertForm").on("submit", function(e) {
    ...
    e.preventDefault();
    $.ajax({
      url: "commentRepos.php?action=insertData",
      type: "POST",
  ...
  $("#myTable").on("click", ".deleteBtn", function() {
    if(confirm("Are you sure you want to delete this user?")) {
      ...
      $.ajax({
        url: "commentRepos.php?action=deleteData",
        type: "POST",
        dataType: "json",
        data: {
          id,
  ...
  $("#myTable").on("click", ".editUser", function() {
    var id = $(this).val();
    $.ajax({
      url: "commentRepos.php?action=fetchSingle",
      type: "POST",
      dataType: "json",
      data: {
        id: id
      ...
      success: function(response) {
        ...
        $("#editForm textarea[name='comment']").val(data.comment);
  ...
  $("#editForm").on("submit", function(e) {
    ...
    e.preventDefault();
    $.ajax({
      url: "commentRepos.php?action=updateData",
      type: "POST",
      data: new FormData(this),
      contentType: false,
      cache: false,
